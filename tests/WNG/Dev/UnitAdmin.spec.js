...
test.describe('Dashboard Validation', () => {
    ...
    test.beforeEach(async ({ page }, testInfo) => {
        ...
        await page.getByRole('textbox', { name: 'Login email' }).pressSequentially('adityau1@mailinator.com', { delay: 100 });
        await page.getByRole('textbox', { name: 'Password' }).pressSequentially('Aditya@uu1', { delay: 100 });
...
`;
        ...
        if (targetValue !== undefined && targetValue !== null) {
            ...
            const iframeWasteNot = page.frameLocator('#wastenot-html');
