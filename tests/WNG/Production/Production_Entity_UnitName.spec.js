...
test.describe('Dashboard Validation', () => {
  ...
  test.beforeEach(async ({ page }, testInfo) => {
    ...
    await page.getByRole('textbox', { name: 'Login email' }).pressSequentially(process.env.GP_ENTITY_USERNAME, { delay: 100 });
    await page.getByRole('textbox', { name: 'Password' }).pressSequentially(process.env.GP_ENTITY_PASSWORD, { delay: 100 });
