...
test.describe('Dashboard Validation', () => {
    ...
    test.beforeEach(async ({ page }, testInfo) => {
       ...
       await page.getByRole('textbox', { name: 'Login email' }).pressSequentially(process.env.GP_UNIT_USERNAME, { delay: 100 });
    await page.getByRole('textbox', { name: 'Password' }).pressSequentially(process.env.GP_UNIT_PASSWORD, { delay: 100 });
